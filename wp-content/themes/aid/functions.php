...
function aid_scripts() {
    ...
    wp_enqueue_script('aid-registrationForm-js', get_template_directory_uri() . '/assets/js/registrationForm.js');

//	wp_enqueue_script('aid-tableTimer-js' , get_template_directory_uri() . '/assets/js/tableTimer.js');
